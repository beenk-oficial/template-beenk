CREATE TYPE IF NOT EXISTS user_type AS ENUM ('admin', 'user', 'owner', 'guest');
CREATE TYPE IF NOT EXISTS company_status AS ENUM ('active', 'inactive', 'suspended', 'pending');
CREATE TYPE IF NOT EXISTS notification_type AS ENUM ('info', 'warning', 'success', 'error');
CREATE TYPE IF NOT EXISTS auth_provider AS ENUM ('email', 'google');
CREATE TYPE IF NOT EXISTS subscription_owner_type AS ENUM ('user', 'company');
...
CREATE TYPE IF NOT EXISTS referral_status AS ENUM ('pending', 'accepted', 'rewarded');
